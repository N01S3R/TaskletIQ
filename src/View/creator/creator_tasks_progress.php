...
<div id="app">
    ...
    <div class="container my-4" v-else>
        ...
        <div ref="tasksContainer" class="custom-row-tasks" style="position: relative;">
    ...
    createApp({
        ...
        mounted() {
            ...
            setTimeout(() => {
                this.loading = false;
                this.$nextTick(() => {
                    this.initializeScrollbar(); // Inicjalizacja PerfectScrollbar po wyrenderowaniu DOM
                });
            }, 1000);
        },
        methods: {
            ...
            initializeScrollbar() {
                const tasksContainer = this.$refs.tasksContainer;
                if (tasksContainer) {
                    new PerfectScrollbar(tasksContainer);
                } else {
                    console.error('Element tasksContainer nie został znaleziony');
                }
            }
        }
    }).mount('#app');
